...
\institute{Nicolas Durrande, PROWLER.io (nicolas@prowler.io) \\ Rodolphe Le Riche, CNRS -- Mines St-\'Etienne -- LIMOS (leriche@emse.fr)}
...
\input{1_stat_models/part_1.tex}
%\input{2_Design_of_experiments/part_2.tex}
\input{3_gaussian_process_regression/part_3.tex}
\input{4_optimization/part_4.tex}
