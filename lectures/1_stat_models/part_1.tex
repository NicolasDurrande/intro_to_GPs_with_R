...
\begin{enumerate}
\item the processing of surface measures for \textit{i)} reconstructing missing measures and \textit{ii)} denoising,
\item minimizing the missfit between a Mogi model of a spherical reservoir and the surface measures.
\end{enumerate}
\hspace{0.4cm}
\end{minipage} 
\begin{minipage}[b]{0.45\textwidth}
\begin{center}
\includegraphics[width=\textwidth]{1_stat_models/figures/contour_ulos}
\end{center}
\end{minipage} 
\end{frame}
