...
####### load data ###########
data <- readMat('data_nonoise.mat')
Glb_xi <- data$locdata[,1]
Glb_yi <- data$locdata[,2]
Glb_zi <- data$locdata[,3]
Glb_ulos <- data$locdata[,4]
...
Glb_CovXdata <<- kExp(Xdata,Xdata,c(5e-4,850,850)) 
